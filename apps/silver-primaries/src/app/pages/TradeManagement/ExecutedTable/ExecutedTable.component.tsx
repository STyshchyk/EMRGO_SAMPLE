...
import { DashboardContent, Panel, PanelContent, PanelHeader, useToast } from "@emrgo-frontend/shared-ui";

import { useAddSellsideStore } from "../../store/store";
import { IExecutedTableCopmonent } from "./ExecutedTable.types";


export const ExecutedTableComponent: FC<IExecutedTableCopmonent> = ({}: IExecutedTableCopmonent) => {
