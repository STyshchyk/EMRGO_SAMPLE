...
const transferMoney = (payload) =>
  baseAxiosInstance({
    method: "PATCH",
    data: payload,
    url: `/accounts/v1/accounts/transfer`,
  });
...
const transferMoneyInternal = (payload) =>
  baseAxiosInstance({
    ...
    url: `/accounts/v1/accounts/transfer/internal`,
  });

const getExternalPaymentsAuditDataById = (payload) =>
  baseAxiosInstance({
    method: "GET",
    url: `/accounts/v1/accounts/payments/outgoing/instruction/audit/${payload.externalPaymentId}`,
  });
