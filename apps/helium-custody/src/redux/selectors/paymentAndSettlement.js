...
export const selectIsFetchingPaymentsList = (state) =>
  state.paymentAndSettlement.isFetchingPaymentsList;
export const selectSettlementInstructionData = (state) =>
  state.paymentAndSettlement.settlementInstructionData;
export const selectIsFetchingSettlementInstructionAuditData = (state) =>
  state.paymentAndSettlement.isFetchingSettlementInstructionAuditData;

export const selectSettlementInstructionAuditHistoryDataList = createSelector(
  [selectSettlementInstructionData],
  (settlementInstructionData) => {
