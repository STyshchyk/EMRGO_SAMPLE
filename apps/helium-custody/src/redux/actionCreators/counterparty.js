...
export const doFetchCounterpartyListSuccess = createAction(
  actionTypes.COUNTERPARTY_LIST_FETCH_SUCCEEDED
);
export const doFetchCounterpartyListFailure = createAction(
  actionTypes.COUNTERPARTY_LIST_FETCH_FAILED
);
...
export const doFetchCounterpartySSIList = createAction(
  actionTypes.COUNTERPARTY_SSI_LIST_FETCH_REQUESTED
);
export const doFetchCounterpartySSIListSuccess = createAction(
  actionTypes.COUNTERPARTY_SSI_LIST_FETCH_SUCCEEDED
);
export const doFetchCounterpartySSIListFailure = createAction(
  actionTypes.COUNTERPARTY_SSI_LIST_FETCH_FAILED
);
...
export const doEditCounterpartySSISuccess = createAction(
  actionTypes.COUNTERPARTY_SSI_EDIT_SUCCEEDED
);
...
export const doDeleteCounterpartySSISuccess = createAction(
  actionTypes.COUNTERPARTY_SSI_DELETE_SUCCEEDED
);
export const doDeleteCounterpartySSIFailure = createAction(
  actionTypes.COUNTERPARTY_SSI_DELETE_FAILED
);
