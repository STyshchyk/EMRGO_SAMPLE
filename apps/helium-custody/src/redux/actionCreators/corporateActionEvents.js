...
export const doSubmitClientResponseSuccess = createAction(
  actionTypes.CA_EVENT_CLIENT_RESPONSE_SUCCEEDED
);
export const doSubmitClientResponseFailure = createAction(
  actionTypes.CA_EVENT_CLIENT_RESPONSE_FAILED
);

export const doFetchCAEventbyId = createAction(actionTypes.CA_EVENT_FETCH_CA_EVENT_REQUESTED);
export const doFetchCAEventbyIdSuccess = createAction(
  actionTypes.CA_EVENT_FETCH_CA_EVENT_SUCCEEDED
);
