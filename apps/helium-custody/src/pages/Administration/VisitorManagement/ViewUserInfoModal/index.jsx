...
const ViewUserInfoModal = ({ open, onClose, selectedUserInfo }) => {
  const { t } = useTranslation(["onboarding"]);
  const { userStatus, userTimeline, user } = selectedUserInfo;
    ...
    ...regionSwitcher({
      sa: [
        ...
        createData(
          ...
          dateFormatter(user?.individualKyc?.passportExpiry, "DD/MM/YYYY HH:mm")
        ),
      ],
  ...
  const userTimelineRows = [
    createData(
      t("onboarding:Info.Last Login"),
      dateFormatter(userTimeline?.lastLogin, "DD/MM/YYYY HH:mm")
    ),
    createData(
      t("onboarding:Info.Date of Invitation ( reminder after 3 days )"),
      dateFormatter(userTimeline?.dateOfInvitation, "DD/MM/YYYY HH:mm")
    ),
    createData(
      t("onboarding:Info.Date of T&C Accepted"),
      dateFormatter(userTimeline?.dateOfTnCAcceptance, "DD/MM/YYYY HH:mm")
    ),
    createData(
      t("onboarding:Info.Date of Onboarding"),
      dateFormatter(userTimeline?.dateOfOnboarding, "DD/MM/YYYY HH:mm")
    ),
    createData(
      t("onboarding:Info.Date of Entity KYC requested"),
      dateFormatter(userTimeline?.dateOfKycRequest, "DD/MM/YYYY HH:mm")
    ),
    createData(
      t("onboarding:Info.Date of Entity KYC start"),
      dateFormatter(userTimeline?.dateOfKycStart, "DD/MM/YYYY HH:mm")
    ),
    createData(
      t("onboarding:Info.Date of Entity KYC complete/User Approval"),
      dateFormatter(userTimeline?.dateOfKycComplete, "DD/MM/YYYY HH:mm")
    ),
