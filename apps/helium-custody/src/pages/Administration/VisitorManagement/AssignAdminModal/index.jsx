...
const AssignAdminModal = ({ open, onClose, selectedRow, assignUserAdmin }) => {
    ...
    <Fragment>
      <Formik
        ...
        onSubmit={(values, { setSubmitting }) => {
          ...
          assignUserAdmin(requestPayload);
        }}
      >
        {({ handleSubmit }) => (
          <Form>
            ...
            >
              <DialogTitle id="edit-group-types-form-dialog-title">
                {t("onboarding:Forms.Are you sure you want to assign user as an admin?")}
              </DialogTitle>
