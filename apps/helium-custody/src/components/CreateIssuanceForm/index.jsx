...
const CreateIssuanceForm = ({ handleClose, formOptions, open }) => {
  ...
  return (
    <Dialog
      ...
      aria-labelledby="add-issuance-form-dialog"
      fullWidth
    >
      <DialogTitle>
      ...
      <DialogContent dir={locale.rtl ? "rtl" : "ltr"}>
        <Box mb={2}>
          <Formik
            ...
            validationSchema={issuanceFormSchema}
              ...
              <Form>
                <Grid container spacing={1}>
                  ...
                  <Grid item container spacing={1} direction="column">
                    ...
                    {(values.sukukType?.label === "Hybrid" ||
                      values.sukukType?.label === "Hybrid_AR") && (
                      <Grid item>
                        <Field
                          component={TextField}
                      ...
                      <Select
                        ...
                        placeholder={t(
                          appConfig.appRegion === "SA"
                            ? "issuances:New Issuance Modal.Capital Market Institution"
                            : "Co-Arranger"
                        )}
                  ...
                  <Grid item container spacing={1}>
                    ...
                    <Grid item container md={12} spacing={2}>
                        ...
                        <Grid item container md={12} alignItems="center">
                          <Grid item>
                            <FormLabel component="legend">
                              {t("issuances:New Issuance Modal.Version")}
                            </FormLabel>
                          </Grid>
                      ...
                      <Grid item container alignItems="center" spacing={1}>
                        <Grid item>
                          <FormLabel component="legend">
                            {t("issuances:New Issuance Modal.Distribution Method")}
                          </FormLabel>
                        </Grid>
                        <Grid item>
                          <Field
                            ...
                            Label={{ label: t("issuances:New Issuance Modal.Private Placement") }}
                          />
                        </Grid>
                      </Grid>
                      ...
                      <Grid item md={12} container direction="column" spacing={1}>
                        <Grid item>
                          <FormLabel component="legend">
                            {t("issuances:New Issuance Modal.Engagement Settings")}
                          </FormLabel>
                        </Grid>
                        <Grid item container direction="column">
                          <Grid item>
                            <Field
                              component={CheckboxWithLabel}
                              type="checkbox"
                              name="hasLegalCounsel"
                              Label={{
                                label: t("issuances:New Issuance Modal.Arranger Counsel Only"),
                              }}
                            />
                          </Grid>
                          <Grid item>
                            <Field
                              component={CheckboxWithLabel}
                              type="checkbox"
                              name="hasObligorIssuerInvite"
                              Label={{
                                label: t("issuances:New Issuance Modal.Obligor Engages Issuer"),
                              }}
                            />
                          </Grid>
                        </Grid>
