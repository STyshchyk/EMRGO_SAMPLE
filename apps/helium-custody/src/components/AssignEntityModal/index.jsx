...
const AssignEntityModal = ({ isModalOpen, handleClose, submitAssignForm, data, entities }) => {
    ...
    if (type.value === "SERVICE_PROVIDER") {
      return [
        { label: i18n.language === "ar-SA" ? "الجهة المنظمة" : "Arranger", value: "ARRANGER" },
        {
          ...
          value: "FIDUCIARY_SERVICE_PROVIDER",
        },
        {
  ...
  const getInitialValue = () => {
    ...
    const selfAssessment = classificationOptions.filter(
      (et) => et.value === data?.selfAssessment
    )[0];
    const formValue = {
            ...
            >
              ...
              <DialogActions>
                ...
                <Button
                  ...
                  variant="contained"
                  color="primary"
                  disabled={!(values.role && (values.entityName || values.entityId))}
                >
                  {t("administration:KYC.KYCManage.AssignEntityModal.Assign & Approve")}
                </Button>
              </DialogActions>
