...
const SecuritiesRegistrationForm = ({ handleSubmit }) => {
  ...
  return (
    <Formik
      ...
      enableReinitialize
      validationSchema={submitPrimIssuanceSecForAdmissionFormSchema}
    >
            ...
            <Grid container spacing={2} direction="column">
              ...
              <Grid item>
                <Button
                  ...
                  type="submit"
                  disabled={!hasCSDDropdownOptionValueBeenSelected}
                >
                  <Typography variant="button">
                    {t("securitiesRegistration:SubmitButtonText")}
                  </Typography>
                </Button>
              </Grid>
            </Grid>
...
const SubmitForSecuritiesRegistrationDialog = ({ sukukData, open, handleClose }) => {
  ...
  const handleSubmit = (values) => {
    const submitSukukForAdmission = (payload) =>
      dispatch(admissionActionCreators.doSubmitSukukForAdmission(payload));
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <Box mb={2}>
          <SecuritiesRegistrationForm
            handleSubmit={handleSubmit}
            isSubmitting={submittingTerms}
