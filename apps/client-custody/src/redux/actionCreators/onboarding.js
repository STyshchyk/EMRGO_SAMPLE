...
export const doFetchRMVisitorsRequest = createAction(
  actionTypes.ONBOARDING_FETCH_RM_VISITORS_REQUESTED
);
export const doFetchRMVisitorsSuccess = createAction(
  actionTypes.ONBOARDING_FETCH_RM_VISITORS_SUCCEEDED
);
export const doFetchRMVisitorsFailure = createAction(
  actionTypes.ONBOARDING_FETCH_RM_VISITORS_FAILED
);
...
export const doProcessVisitorRequest = createAction(
  actionTypes.ONBOARDING_PROCESS_VISITOR_REQUESTED
);
export const doProcessVisitorSuccess = createAction(
  actionTypes.ONBOARDING_PROCESS_VISITOR_SUCCEEDED
);
export const doProcessVisitorFailure = createAction(actionTypes.ONBOARDING_PROCESS_VISITOR_FAILED);

export const doFetchUserInfoRequest = createAction(
  actionTypes.ONBOARDING_FETCH_USER_INFO_REQUESTED
);
export const doFetchUserInfoSuccess = createAction(
  actionTypes.ONBOARDING_FETCH_USER_INFO_SUCCEEDED
);
...
export const doResendOnboardingEmailRequest = createAction(
  actionTypes.ONBOARDING_RESEND_ONBOARDING_EMAIL_REQUESTED
);
export const doResendOnboardingEmailSuccess = createAction(
  actionTypes.ONBOARDING_RESEND_ONBOARDING_EMAIL_SUCCEEDED
);
export const doResendOnboardingEmailFailure = createAction(
  actionTypes.ONBOARDING_RESEND_ONBOARDING_EMAIL_FAILED
);
