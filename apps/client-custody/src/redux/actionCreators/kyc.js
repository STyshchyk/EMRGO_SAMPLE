...
export const doFetchClientClassificationDropdownsSuccess = createAction(actionTypes.FETCH_CC_DROPDOWNS_SUCCEEDED);
export const doFetchClientClassificationDropdownsFailure = createAction(actionTypes.FETCH_CC_DROPDOWNS_FAILED);

export const doPostKYCClassificationData = createAction(actionTypes.KYC_CC_DATA_POST_REQUESTED);
export const doPostKYCClassificationDataSuccess = createAction(actionTypes.KYC_CC_DATA_POST_SUCCEEDED);
...
export const doPostKYCRequirementsDataSuccess = createAction(actionTypes.KYC_REQ_DATA_POST_SUCCEEDED);
...
export const doPostKYCSanctionsDataSuccess = createAction(actionTypes.KYC_SANCTIONS_DATA_POST_SUCCEEDED);
export const doPostKYCSanctionsDataFailure = createAction(actionTypes.KYC_SANCTIONS_DATA_POST_FAILED);
...
export const doFetchPaymentAccountsSuccess = createAction(actionTypes.PAYMENT_ACCOUNTS_FETCH_SUCCEEDED);
export const doFetchPaymentAccountsFailure = createAction(actionTypes.PAYMENT_ACCOUNTS_FETCH_FAILED);

export const doFetchPaymentAccountsByEntityID = createAction(actionTypes.PAYMENT_ACCOUNTS_FETCH_BY_ENTITY_ID_REQUESTED);
export const doFetchPaymentAccountsByEntityIDSuccess = createAction(actionTypes.PAYMENT_ACCOUNTS_FETCH_BY_ENTITY_ID_SUCCEEDED);
export const doFetchPaymentAccountsByEntityIDFailure = createAction(actionTypes.PAYMENT_ACCOUNTS_FETCH_BY_ENTITY_ID_FAILED);

export const doUploadSupportingDocumentForPaymentAccount = createAction(actionTypes.PAYMENT_ACCOUNTS_UPLOAD_SUPPORTING_DOC_FILE_REQUESTED);
export const doUploadSupportingDocumentForPaymentAccountSuccess = createAction(actionTypes.PAYMENT_ACCOUNTS_UPLOAD_SUPPORTING_DOC_FILE_SUCCEEDED);
export const doUploadSupportingDocumentForPaymentAccountFailure = createAction(actionTypes.PAYMENT_ACCOUNTS_UPLOAD_SUPPORTING_DOC_FILE_FAILED);
...
export const doDeletePaymentAccountSuccess = createAction(actionTypes.PAYMENT_ACCOUNTS_DELETE_SUCCEEDED);
export const doDeletePaymentAccountFailure = createAction(actionTypes.PAYMENT_ACCOUNTS_DELETE_FAILED);

export const doEditPaymentAccount = createAction(actionTypes.PAYMENT_ACCOUNTS_EDIT_REQUESTED);
export const doEditPaymentAccountSuccess = createAction(actionTypes.PAYMENT_ACCOUNTS_EDIT_SUCCEEDED);
export const doEditPaymentAccountFailure = createAction(actionTypes.PAYMENT_ACCOUNTS_EDIT_FAILED);

export const doSetPaymentAccountAsDefault = createAction(actionTypes.PAYMENT_ACCOUNTS_SET_AS_DEFAULT_REQUESTED);
export const doSetPaymentAccountAsDefaultSuccess = createAction(actionTypes.PAYMENT_ACCOUNTS_SET_AS_DEFAULT_SUCCEEDED);
export const doSetPaymentAccountAsDefaultFailure = createAction(actionTypes.PAYMENT_ACCOUNTS_SET_AS_DEFAULT_FAILED);

export const doValidatePaymentAccount = createAction(actionTypes.PAYMENT_ACCOUNTS_VALIDATE_REQUESTED);
export const doValidatePaymentAccountSuccess = createAction(actionTypes.PAYMENT_ACCOUNTS_VALIDATE_SUCCEEDED);
export const doValidatePaymentAccountFailure = createAction(actionTypes.PAYMENT_ACCOUNTS_VALIDATE_FAILED);

export const doFetchUploadedSupportingDocumentFile = createAction(actionTypes.PAYMENT_ACCOUNTS_FETCH_UPLOADED_SUPPORTING_DOCUMENT_FILE_REQUESTED);
export const doFetchUploadedSupportingDocumentFileSuccess = createAction(actionTypes.PAYMENT_ACCOUNTS_FETCH_UPLOADED_SUPPORTING_DOCUMENT_FILE_SUCCEEDED);
export const doFetchUploadedSupportingDocumentFileFailure = createAction(actionTypes.PAYMENT_ACCOUNTS_FETCH_UPLOADED_SUPPORTING_DOCUMENT_FILE_FAILED);
