...
export const doSubmitSukukForAdmission = createAction(actionTypes.SUBMIT_ISSUANCE_FOR_ADMISSION_REQUESTED);
export const doSubmitSukukForAdmissionSuccess = createAction(actionTypes.SUBMIT_ISSUANCE_FOR_ADMISSION_SUCCEEDED);
export const doSubmitSukukForAdmissionFailure = createAction(actionTypes.SUBMIT_ISSUANCE_FOR_ADMISSION_FAILED);
