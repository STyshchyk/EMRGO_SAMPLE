...
export const doFetchEntityGroupDetailsSuccess = createAction(
  actionTypes.ENTITY_GROUP_DETAILS_SUCCEEDED
);
export const doFetchEntityGroupDetailsFailure = createAction(
  actionTypes.ENTITY_GROUP_DETAILS_FAILED
);

export const doRequestEntityGroupUserEdit = createAction(
  actionTypes.ENTITY_GROUP_USER_ACL_EDIT_REQUESTED
);
export const doRequestEntityGroupUserEditSuccess = createAction(
  actionTypes.ENTITY_GROUP_USER_ACL_EDIT_SUCCEEDED
);
export const doRequestEntityGroupUserEditFailure = createAction(
  actionTypes.ENTITY_GROUP_USER_ACL_EDIT_FAILED
);
...
export const doAttachEntityUserToEntityGroup = createAction(
  actionTypes.ATTACH_ENTITY_USER_TO_ENTITY_GROUP_REQUESTED
);
export const doAttachEntityUserToEntityGroupSuccess = createAction(
  actionTypes.ATTACH_ENTITY_USER_TO_ENTITY_GROUP_SUCCEEDED
);
export const doAttachEntityUserToEntityGroupFailure = createAction(
  actionTypes.ATTACH_ENTITY_USER_TO_ENTITY_GROUP_FAILED
);
