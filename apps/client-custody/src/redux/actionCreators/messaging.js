...
export const doSubmitMessagesRequest = createAction(
  actionTypes.MESSAGING_SUBMIT_MESSAGES_REQUESTED
);
export const doSubmitMessagesSuccess = createAction(
  actionTypes.MESSAGING_SUBMIT_MESSAGES_SUCCEEDED
);
