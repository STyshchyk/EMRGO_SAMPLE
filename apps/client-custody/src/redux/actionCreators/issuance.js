...
export const doFetchIssuanceOverviewSuccess = createAction(actionTypes.ISSUANCE_OVERVIEW_FETCH_SUCCEEDED);
export const doFetchIssuanceOverviewFailure = createAction(actionTypes.ISSUANCE_OVERVIEW_FETCH_FAILED);
...
export const doPublishTermsheetSuccess = createAction(actionTypes.ISSUANCE_TERMSHEET_PUBLISH_SUCCEEDED);
export const doPublishTermsheetFailure = createAction(actionTypes.ISSUANCE_TERMSHEET_PUBLISH_FAILED);

export const doReviewTermsheet = createAction(actionTypes.ISSUANCE_TERMSHEET_REVIEW_REQUESTED);
export const doReviewTermsheetSuccess = createAction(actionTypes.ISSUANCE_TERMSHEET_REVIEW_SUCCEEDED);
...
export const doFinalizeTermsheetSuccess = createAction(actionTypes.ISSUANCE_TERMSHEET_FINALIZE_SUCCEEDED);
export const doFinalizeTermsheetFailure = createAction(actionTypes.ISSUANCE_TERMSHEET_FINALIZE_FAILED);

export const doFetchFinalterms = createAction(actionTypes.ISSUANCE_TERMSHEET_FINAL_TERMS_REQUESTED);
export const doFetchFinaltermsSuccess = createAction(actionTypes.ISSUANCE_TERMSHEET_FINAL_TERMS_SUCCEEDED);
export const doFetchFinaltermsFailure = createAction(actionTypes.ISSUANCE_TERMSHEET_FINAL_TERMS_FAILED);

export const doApproveTermsheet = createAction(actionTypes.ISSUANCE_TERMSHEET_APPROVE_REQUESTED);
export const doApproveTermsheetSuccess = createAction(actionTypes.ISSUANCE_TERMSHEET_APPROVE_SUCCEEDED);
export const doApproveTermsheetFailure = createAction(actionTypes.ISSUANCE_TERMSHEET_APPROVE_FAILED);
...
export const doConfirmSubscriptionSuccess = createAction(actionTypes.SUBSCRIPTION_CONFIRM_SUCCEEDED);
...
export const doFinaliseSubscriptionSuccess = createAction(actionTypes.SUBSCRIPTION_FINALISE_SUCCEEDED);
...
export const doFetchServiceProvidersSuccess = createAction(actionTypes.SERVICE_PROVIDER_FETCH_SUCCEEDED);
export const doFetchServiceProvidersFailure = createAction(actionTypes.SERVICE_PROVIDER_FETCH_FAILED);

export const doEngageServiceProvider = createAction(actionTypes.SERVICE_PROVIDER_ENGAGEMENT_REQUESTED);
export const doEngageServiceProviderSuccess = createAction(actionTypes.SERVICE_PROVIDER_ENGAGEMENT_SUCCEEDED);
export const doEngageServiceProviderFailure = createAction(actionTypes.SERVICE_PROVIDER_ENGAGEMENT_FAILED);

export const doFetchEngagementRequests = createAction(actionTypes.ENGAGEMENT_REQUESTS_FETCH_REQUESTED);
export const doFetchEngagementRequestsSuccess = createAction(actionTypes.ENGAGEMENT_REQUESTS_FETCH_SUCCEEDED);
export const doFetchEngagementRequestsFailure = createAction(actionTypes.ENGAGEMENT_REQUESTS_FETCH_FAILED);

export const doUploadEngagementLetter = createAction(actionTypes.ENGAGEMENT_LETTER_UPLOAD_REQUESTED);
export const doUploadEngagementLetterSuccess = createAction(actionTypes.ENGAGEMENT_LETTER_UPLOAD_SUCCEEDED);
export const doUploadEngagementLetterFailure = createAction(actionTypes.ENGAGEMENT_LETTER_UPLOAD_FAILED);

export const doRequestSignature = createAction(actionTypes.ENGAGEMENT_LETTER_SIGNATURE_REQUESTED);
export const doRequestSignatureSuccess = createAction(actionTypes.ENGAGEMENT_LETTER_SIGNATURE_SUCCEEDED);
export const doRequestSignatureFailure = createAction(actionTypes.SUBSCRIPTION_FINALISE_FAILED);

export const doFetchEngagementLetterUrl = createAction(actionTypes.ENGAGEMENT_LETTER_URL_FETCH_REQUESTED);
export const doFetchEngagementLetterUrlSuccess = createAction(actionTypes.ENGAGEMENT_LETTER_URL_FETCH_SUCCEEDED);
export const doFetchEngagementLetterUrlFailure = createAction(actionTypes.ENGAGEMENT_LETTER_URL_FETCH_FAILED);

export const doFetchEngagementStatus = createAction(actionTypes.ENGAGEMENT_STATUS_FETCH_REQUESTED);
export const doFetchEngagementStatusSuccess = createAction(actionTypes.ENGAGEMENT_STATUS_FETCH_SUCCEEDED);
export const doFetchEngagementStatusFailure = createAction(actionTypes.ENGAGEMENT_STATUS_FETCH_FAILED);

export const doFetchEngagementObligorProposal = createAction(actionTypes.ENGAGEMENT_OBLIGOR_PROPOSAL_FETCH_REQUESTED);
export const doFetchEngagementObligorProposalSuccess = createAction(actionTypes.ENGAGEMENT_OBLIGOR_PROPOSAL_FETCH_SUCCEEDED);
export const doFetchEngagementObligorProposalFailure = createAction(actionTypes.ENGAGEMENT_OBLIGOR_PROPOSAL_FETCH_FAILED);

export const doSubmitBypassSignedEngagement = createAction(actionTypes.SUBMIT_BYPASS_SIGNED_ENGAGEMENT_REQUESTED);
export const doSubmitBypassSignedEngagementSuccess = createAction(actionTypes.SUBMIT_BYPASS_SIGNED_ENGAGEMENT_SUCCEEDED);
export const doSubmitBypassSignedEngagementFailure = createAction(actionTypes.SUBMIT_BYPASS_SIGNED_ENGAGEMENT_FAILED);
...
export const doSigningFetchPreActionSuccess = createAction(actionTypes.SIGNING_FETCH_PREACTION_SUCCEEDED);
export const doSigningFetchPreActionFailure = createAction(actionTypes.SIGNING_FETCH_PREACTION_FAILED);

export const doSigningFetchCompleteAgenda = createAction(actionTypes.SIGNING_COMPLETE_AGENDA_REQUESTED);
export const doSigningFetchCompleteAgendaSuccess = createAction(actionTypes.SIGNING_COMPLETE_AGENDA_SUCCEEDED);
export const doSigningFetchCompleteAgendaFailure = createAction(actionTypes.SIGNING_COMPLETE_AGENDA_FAILED);
...
export const doFetchAuthlessDocusignLink = createAction(actionTypes.AUTHLESS_DOCUSIGN_LINK_REQUESTED);
export const doFetchAuthlessDocusignLinkSuccess = createAction(actionTypes.AUTHLESS_DOCUSIGN_LINK_SUCCEEDED);
export const doFetchAuthlessDocusignLinkFailure = createAction(actionTypes.AUTHLESS_DOCUSIGN_LINK_FAILED);

export const doFetchReviewDocusignLink = createAction(actionTypes.REVIEW_DOCUSIGN_LINK_REQUESTED);
export const doFetchReviewDocusignLinkSuccess = createAction(actionTypes.REVIEW_DOCUSIGN_LINK_SUCCEEDED);
export const doFetchReviewDocusignLinkFailure = createAction(actionTypes.REVIEW_DOCUSIGN_LINK_FAILED);
...
export const doFetchSigningPostAction = createAction(actionTypes.SIGNING_POSTACTION_FETCH_REQUESTED);
export const doFetchSigningPostActionSuccess = createAction(actionTypes.SIGNING_POSTACTION_FETCH_SUCCEEDED);
export const doFetchSigningPostActionFailure = createAction(actionTypes.SIGNING_POSTACTION_FETCH_FAILED);

export const doUpdateSigningPostAction = createAction(actionTypes.SIGNING_POSTACTION_UPDATE_REQUESTED);
export const doUpdateSigningPostActionSuccess = createAction(actionTypes.SIGNING_POSTACTION_UPDATE_SUCCEEDED);
export const doUpdateSigningPostActionFailure = createAction(actionTypes.SIGNING_POSTACTION_UPDATE_FAILED);
...
export const doInitializeClosingSuccess = createAction(actionTypes.CLOSING_INITIALIZATION_SUCCEEDED);
...
export const doFetchAdmissionTermsheetData = createAction(actionTypes.ADMISSION_TERMSHEET_DATA_REQUESTED);
export const doFetchAdmissionTermsheetDataSuccess = createAction(actionTypes.ADMISSION_TERMSHEET_DATA_SUCCEEDED);
export const doFetchAdmissionTermsheetDataFailure = createAction(actionTypes.ADMISSION_TERMSHEET_DATA_FAILED);
...
export const doSetAdmissionTermsObjectURL = createAction(actionTypes.ADMISSION_SET_TERMS_OBJECT_URL);
export const doClearAdmissionTermsObjectURL = createAction(actionTypes.ADMISSION_CLEAR_TERMS_OBJECT_URL);

export const doSubmitAdmissionTerms = createAction(actionTypes.SUBMIT_ADMISSION_TERMS_REQUESTED);
export const doSubmitAdmissionTermsSuccess = createAction(actionTypes.SUBMIT_ADMISSION_TERMS_SUCCEEDED);
export const doSubmitAdmissionTermsFailure = createAction(actionTypes.SUBMIT_ADMISSION_TERMS_FAILED);

export const doFetchAdmissionStatus = createAction(actionTypes.FETCH_ADMISSION_STATUS_REQUESTED);
export const doFetchAdmissionStatusSuccess = createAction(actionTypes.FETCH_ADMISSION_STATUS_SUCCEEDED);
export const doFetchAdmissionStatusFailure = createAction(actionTypes.FETCH_ADMISSION_STATUS_FAILED);
...
export const doFetchCMAIssuanceApprovalStatus = createAction(actionTypes.FETCH_CMA_ISSUANCE_APPROVAL_STATUS_REQUESTED);
export const doFetchCMAIssuanceApprovalStatusSuccess = createAction(actionTypes.FETCH_CMA_ISSUANCE_APPROVAL_STATUS_SUCCEEDED);
export const doFetchCMAIssuanceApprovalStatusFailure = createAction(actionTypes.FETCH_CMA_ISSUANCE_APPROVAL_STATUS_FAILED);

export const doFetchCMASPEIncorporationApprovalStatus = createAction(actionTypes.FETCH_CMA_SPE_INCORPORATION_APPROVAL_STATUS_REQUESTED);
export const doFetchCMASPEIncorporationApprovalStatusSuccess = createAction(actionTypes.FETCH_CMA_SPE_INCORPORATION_APPROVAL_STATUS_SUCCEEDED);
export const doFetchCMASPEIncorporationApprovalStatusFailure = createAction(actionTypes.FETCH_CMA_SPE_INCORPORATION_APPROVAL_STATUS_FAILED);

export const doConfirmCMAIssuanceApprovalStatus = createAction(actionTypes.CONFIRM_CMA_ISSUANCE_APPROVAL_STATUS_REQUESTED);
export const doConfirmCMAIssuanceApprovalStatusSuccess = createAction(actionTypes.CONFIRM_CMA_ISSUANCE_APPROVAL_STATUS_SUCCEEDED);
export const doConfirmCMAIssuanceApprovalStatusFailure = createAction(actionTypes.CONFIRM_CMA_ISSUANCE_APPROVAL_STATUS_FAILED);

export const doConfirmCMASPEIncorporationApprovalStatus = createAction(actionTypes.CONFIRM_CMA_SPE_INCORPORATION_APPROVAL_STATUS_REQUESTED);
export const doConfirmCMASPEIncorporationApprovalStatusSuccess = createAction(actionTypes.CONFIRM_CMA_SPE_INCORPORATION_APPROVAL_STATUS_SUCCEEDED);
export const doConfirmCMASPEIncorporationApprovalStatusFailure = createAction(actionTypes.CONFIRM_CMA_SPE_INCORPORATION_APPROVAL_STATUS_FAILED);

export const doUploadCMARelatedDoc = createAction(actionTypes.UPLOAD_CMA_RELATED_DOC_REQUESTED);
export const doUploadCMARelatedDocSuccess = createAction(actionTypes.UPLOAD_CMA_RELATED_DOC_SUCCEEDED);
...
export const doFetchIssuancesByStatus = createAction(actionTypes.ISSUANCES_FETCH_BY_STATUS_REQUESTED);
export const doFetchIssuancesByStatusSuccess = createAction(actionTypes.ISSUANCES_FETCH_BY_STATUS_SUCCEEDED);
export const doFetchIssuancesByStatusFailure = createAction(actionTypes.ISSUANCES_FETCH_BY_STATUS_FAILED);
...
export const doResetIssuanceTermsheet = createAction(actionTypes.ISSUANCE_TERMSHEET_RESET_REQUESTED);
