...
export const doFetchSukukOverviewDataSuccess = createAction(actionTypes.SUKUK_OVERVIEW_DATA_SUCCEEDED);
export const doFetchSukukOverviewDataFailure = createAction(actionTypes.SUKUK_OVERVIEW_DATA_FAILED);
export const doResetSukukOverviewData = createAction(actionTypes.SUKUK_OVERVIEW_DATA_RESET_REQUESTED);
