...
export const doFetchDropdownOptionsSuccess = createAction(actionTypes.FETCH_DROPDOWN_OPTIONS_SUCCEEDED);
export const doFetchDropdownOptionsFailure = createAction(actionTypes.FETCH_DROPDOWN_OPTIONS_FAILED);
