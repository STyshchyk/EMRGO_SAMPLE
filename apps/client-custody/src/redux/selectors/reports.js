...
export const selectCashTransactions = createSelector([selectCashTransactionsData], (transactionsData) => {
  if (transactionsData) {
    const finalData = [];
...
export const selectSecuritiesAccounts = createSelector([selectSecuritiesAccountsData], (accountsData) => {
  if (accountsData) {
    return accountsData.map((account) => {
...
export const selectSecuritiesTransactions = createSelector([selectSecuritiesTransactionsData], (transactionsData) => {
...
export const selectTradeDatedSecuritiesHoldingsData = (state) => state.reports.tradeDatedSecuritiesHoldings;
...
export const selectIsFetchingSecuritiesHoldings = (state) => state.reports.isFetchingSecuritiesHoldings;
export const selectIsFetchingTradeDatedSecuritiesHoldings = (state) => state.reports.isFetchingTradeDatedSecuritiesHoldings;
