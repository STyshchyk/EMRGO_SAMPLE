export const selectSupportTicketTypeDropdowns = (state) => state.support?.dropDowns?.supportTicketType;
...
export const selectCurrentTFAVerificationDocument = (state) => state.support?.currentTFAVerificationDocument;
