...
export const selectListOfValidACLNames = createSelector([selectAccessControlsData], (accessControlsData) => {
...
export const selectListOfACLKeys = createSelector([selectAccessControlsData], (accessControlsData) => {
  if (accessControlsData?.accessControls) {
    const accessControls = accessControlsData?.accessControls;
