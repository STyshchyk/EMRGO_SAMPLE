...
export const hasSuccessfullyRequestedPassword = (state) =>
  state.auth?.hasSuccessfullyRequestedPassword;
...
export const hasMFAVerified = (state) =>
  state.auth?.authenticatedUserObject?.isMFACodeVerified ?? false;
...
export const selectCurrentListOfAcls = createSelector(
...
export const selectOwnEntityGroupNames = createSelector(
  [selectOwnEntityGroups],
  (ownEntityGroups) => {
    const names = [];
...
export const selectCurrentEntityType = createSelector(
  [selectCurrentEntityGroup],
  (currentEntityGroup) => currentEntityGroup?.entityType
);

export const selectCurrentCorporateEntityName = createSelector(
  [selectCurrentEntityGroup],
  (currentEntityGroup) => currentEntityGroup?.entity?.corporateEntityName
);

export const selectUserDisplayRole = createSelector(
  [selectAuthenticatedUserObject],
  (authenticatedUserObject) => {
...
export const selectCorporateEntityName = createSelector(
  [selectUserEntity],
  (userEntity) => userEntity?.corporateEntityName ?? ""
);
