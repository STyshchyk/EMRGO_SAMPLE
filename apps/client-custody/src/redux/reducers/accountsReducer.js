...
const accountsReducer = handleActions(
  {
    ...
    [accountsActionCreators.doFetchPaymentAccountsSuccess]: produce((draft, { payload: { data } }) => {
      draft.isFetching = false;
    ...
    [accountsActionCreators.doEditPaymentAccountSuccess]: produce((draft, { payload: { data } }) => {
      draft.isRequesting = false;
      draft.message = data;
    }),
    ...
    [accountsActionCreators.doUploadAccountFile]: produce((draft, { payload: { index, keyName } }) => {
      draft.errorMessage = null;
    ...
    [accountsActionCreators.doUpdateInvestorPaymentSuccess]: produce((draft, { payload: { data } }) => {
      draft.isSubmitting = false;
      draft.message = data;
    }),
    ...
    [accountsActionCreators.doUploadSupportingDocumentForPaymentAccount]: produce((draft, { payload }) => {
      draft.errorMessage = null;
    ...
    [accountsActionCreators.doUploadSupportingDocumentForPaymentAccountSuccess]: produce((draft, { payload: { data } }) => {
      const key = data.keyName || data.name;
      draft.filesUploaded[key] = data;
      draft.uploadStatus[key] = false;
      draft.errorMessage = null;
    ...
    [accountsActionCreators.doUploadSupportingDocumentForPaymentAccountFailure]: produce((draft, { payload, key }) => {
      draft.uploadInProgress -= 1;
      draft.uploadStatus[key] = false;
      draft.errorMessage = payload;
    }),
    [accountsActionCreators.doFetchUploadedSupportingDocumentFile]: produce((draft, { payload }) => {
      const key = payload.fileName;
      draft.errorMessage = null;
      draft.downloadStatus[key] = true;
      draft.isDownloadingFile = true;
    }),
    [accountsActionCreators.doFetchUploadedSupportingDocumentFileSuccess]: produce((draft, { payload: { data } }) => {
      const key = data.fileName;
      draft.isDownloadingFile = false;
      draft.downloadStatus[key] = data.link;
    }),
    [accountsActionCreators.doFetchUploadedSupportingDocumentFileFailure]: produce((draft, { payload, key }) => {
      draft.isDownloadingFile = false;
      draft.errorMessage = payload;
    ...
    [accountsActionCreators.doCreateOutgoingInstructionsSuccess]: produce((draft, { payload: { data } }) => {
      draft.isSubmitting = false;
      draft.message = data;
    }),
    ...
    [accountsActionCreators.doApproveOutgoingPaymentInstructionSuccess]: produce((draft, { payload }) => {
      draft.isRequesting = false;
      draft.message = payload;
    }),
    [accountsActionCreators.doApproveOutgoingPaymentInstructionFailure]: produce((draft, { payload }) => {
      draft.isRequesting = false;
      draft.errorMessage = payload;
    }),
    ...
    [accountsActionCreators.doFinalizeOutgoingPaymentInstructionSuccess]: produce((draft, { payload }) => {
      draft.isRequesting = false;
      draft.message = payload;
    }),
    [accountsActionCreators.doFinalizeOutgoingPaymentInstructionFailure]: produce((draft, { payload }) => {
      draft.isRequesting = false;
      draft.errorMessage = payload;
    }),
    ...
    [accountsActionCreators.doUpdateOutgoingPaymentInstructionSuccess]: produce((draft, { payload }) => {
      draft.isRequesting = false;
      draft.message = payload;
    }),
    [accountsActionCreators.doUpdateOutgoingPaymentInstructionFailure]: produce((draft, { payload }) => {
      draft.isRequesting = false;
      draft.errorMessage = payload;
    }),
    ...
    [accountsActionCreators.doClientApproveOutgoingPaymentInstructionSuccess]: produce((draft, { payload }) => {
      draft.isRequesting = false;
      draft.message = payload;
    }),
    [accountsActionCreators.doClientApproveOutgoingPaymentInstructionFailure]: produce((draft, { payload }) => {
      draft.isRequesting = false;
      draft.errorMessage = payload;
    }),
