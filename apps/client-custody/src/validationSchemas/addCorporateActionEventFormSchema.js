...
const addCorporateActionEventFormSchema = Yup.object().shape({
  eventType: Yup.string().nullable().required("Event Type is required"),
  ...
  eventStatus: Yup.string().nullable().required("Event Status is required"),
  eventTerms: Yup.string().nullable().required("Event Term is required"),
  mandatoryOrVoluntary: Yup.string().nullable().required("Voluntary/Mandatory is required"),
