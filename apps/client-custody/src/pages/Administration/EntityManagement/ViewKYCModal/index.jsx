...
const ViewKYCModal = ({ entityId, rowData, open, onClose }) => {
  ...
  useEffect(() => {
    if (entityId) {
      ...
      // TODO: uncomment this after permissions sorted
  ...
  const entityIdentificationRows = [
    ...
    createData(
      ...
      }, ${kycData?.registeredAddress?.city || ""}, ${
        selectedRegisteredAddressCountry?.label || ""
  ...
  return (
    <Fragment>
      ...
      >
        <DialogTitle id="set-parent-entity-form-dialog-title">
          <Grid container justifyContent="space-between">
            <Grid item xs container alignContent="center">
              <strong>{t("kyc:Review KYC.Review KYC")}</strong>
            </Grid>
          </Grid>
        </DialogTitle>
        <DialogContent>
              ...
              <TableContainer>
                <Grid container justifyContent="flex-start" alignContent="center">
                  ...
                  <Grid item xs={6} container justifyContent="flex-end" alignContent="center">
                    ...
                    >
                      {t("kyc:Review KYC.Buttons.View Details")}
                    </Button>
                  </Grid>
                </Grid>
                    ...
                    <TableRow>
                      <TableCell colSpan={1} className="w-1/2">
                        <Typography color="primary" className="font-bold">
                          {t("kyc:Review KYC.Item")}
                        </Typography>
                      </TableCell>
                      <TableCell colSpan={1} className="w-1/2">
                        <Typography color="primary" className="font-bold">
                          {t("kyc:Review KYC.Data")}
                        </Typography>
                      </TableCell>
                    </TableRow>
                  </TableHead>
          ...
          <Grid container justifyContent="flex-end" className="mx-4 mb-4">
            <Grid item xs={12} lg={3} className="px-4">
              <Button variant="outlined" color="primary" fullWidth onClick={onClose}>
                {t("kyc:Review KYC.Buttons.Close")}
              </Button>
            </Grid>
            <Grid item xs={12} lg={3} className="px-4">
              <Button
                ...
                onClick={() => kycRedirect("classification")}
              >
                {t("kyc:Review KYC.Buttons.View KYC")}
              </Button>
            </Grid>
          </Grid>
        </DialogActions>
