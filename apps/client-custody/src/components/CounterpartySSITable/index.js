...
import { counterpartyStatusEnum, settlementLocationEnum } from '../../constants/wethaqAPI/securitiesServices';
...
const CounterpartySSITable = ({ anchorEl, data, actions, setCurrentlySelectedRowData, setAnchorEl, setOpenDialog }) => {
  ...
  const transformData = (originalData) => {
    ...
    const { entity, counterparty, ssiLabel, settlementLocation, deliveryOrReceiveAgentIdType, deliveryOrReceiveIdentifier, sellerOrBuyerIdType, sellerOrBuyerIdentifier, safekeepingAccount, status } =
      originalData;
  ...
  const dedupedCounterpartyNames = Array.from(new Set(data.map((item) => item.counterparty))).sort();
  ...
  return (
    <Fragment>
      ...
      <FilterProvider tableKey="ssiTable">
        ...
        >
          <TableFiltersWrapper columns={columns} tableRef={tableRef} tableKey="ssiTable" exportData={exportData} hideExportButtons>
          ...
          {({ filterColumns, filters }) => {
            ...
            return (
              <Fragment>
                <MaterialTable
                  components={{
                    Header: (props) => <CustomCounterpartyTableHeader {...props} filterColumns={filterColumns} />,
                  }}
                  tableRef={tableRef}
                  size="small"
                  title=""
