  ...
  return (
    <div className={cx(dense ? style.container__dense : style.container, className)}>
      <div className={cx(label !== null ? style['input-group'] : style['input-group--sans-label'])}>
        {label !== null ? (
          <div className={cx(style['input-group__label'], fullWidth ? style['input-group__label--fullwidth'] : '')}>
        ...
        <div className={style['input-group__field']}>
          ...
          />
          <label htmlFor={name} className={cx(style['file-input__label'], { [style['file-input__label--loaded']]: isLoaded }, fullWidth ? style['file-input__label--fullwidth'] : '')}>
            {renderAction()}
          </label>
        </div>
      </div>
