...
const ManageColumnsDialog = ({ open, closeDialog, openResetColumnsDialog }) => {
  ...
  return (
    <Fragment>
      <Dialog fullWidth maxWidth="md" open={open} onClose={() => closeDialog()} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
        <DialogTitle id="alert-dialog-title">{t('miscellaneous:Manage Columns Dialogue.Manage Columns')}</DialogTitle>
        <DialogContent>
            ...
            <Grid container justifyContent="space-between">
              <Grid item xs={5}>
                <Grid container justifyContent="space-between" alignContent="center">
                  ...
                  <Tooltip title={t('miscellaneous:Manage Columns Dialogue.Move all Hidden Columns')} placement="top" aria-label="move hidden">
                    <IconButton
              ...
              <Grid item xs={2} container justifyContent="center" alignContent="flex-start">
                <div className={style.columnManager__swap__wrapper}>
                  <IconButton
                    ...
                    size="large">
                    <Tooltip title={t('miscellaneous:Manage Columns Dialogue.Swap all Columns')} placement="top" aria-label="swap columns">
              ...
              <Grid item xs={5}>
                <Grid container justifyContent="space-between" alignContent="center">
                  <Tooltip title={t('miscellaneous:Manage Columns Dialogue.Move all Shown Columns')} placement="top" aria-label="move shown">
                    <IconButton
                      aria-label="move columns"
                      onClick={() => {
                        moveShownColumns();
        ...
        <DialogActions>
          <Grid container justifyContent="space-between" className="px-4 py-2">
            <Grid item>
              <Button onClick={() => handleResetConfirmClick()} variant="outlined" className="border-red-500 text-red-500">
