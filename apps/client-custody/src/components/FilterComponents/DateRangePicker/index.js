...
const DateRangePicker = ({ name, label, defaultFilter, setEndDateValue, setStartDateValue }) => {
  ...
  const [pickerValues, setPickerValues] = useState({ startDate: defaultStartDate, endDate: defaultEndDate });
    ...
    <Box>
      <Grid container justifyContent="space-between">
        <Grid item xs={9} container alignContent="center" justifyContent="flex-start">
          <Typography variant="body1" className="bold clickable" aria-haspopup="true" onClick={handleDateRangePickerOpen}>
            {label}
          </Typography>
          <KeyboardArrowDownIcon className="bold clickable" aria-haspopup="true" onClick={handleDateRangePickerOpen} />
