...
const IncomingTable = () => {
  ...
  const unallocatedTransfers = useSelector(billingAndPaymentsSelectors.selectUnallocatedTransactions);
  ...
  const fetchUnallocatedTransactions = useCallback((payload) => dispatch(billingAndPaymentsActionCreators.doFetchUnallocatedTransactions(payload)), [dispatch]);
  ...
  return (
    <Fragment>
      <IncomingPaymentsTable loading={isFetchingTransfers} data={rows} actions={actions} setSelectedRow={setSelectedRow} selectedRow={selectedRow} />
      <ViewTransactionDetailsModal isModalOpen={viewModalOpen} setIsModalOpen={setViewModalOpen} selectedTransaction={selectedTransaction} />
      <ReleaseFundsModal isModalOpen={releaseModalOpen} setIsModalOpen={setReleaseModalOpen} selectedTransaction={selectedTransaction} handleRelease={handleRelease} />
      <MoveToSuspenseModal
