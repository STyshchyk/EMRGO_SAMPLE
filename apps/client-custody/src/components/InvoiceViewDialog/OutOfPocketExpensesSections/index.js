...
const OutOfPocketExpensesSections = ({ modalType, localOutOfPocketExpenses, setLocalOutOfPocketExpenses }) => {
  ...
  const handleDeleteOutOfPocketExpenses = (requestObject, resolve) => {
    const filteredTransactions = localOutOfPocketExpenses.filter((charge) => !requestObject.includes(charge.id));
                    ...
                    schema
                      ...
                      .then((valid) => {
                        if (valid) {
                          ...
                          toast.warning('Out of Pocket Expense data inputted is incomplete/invalid.', 2000);
                          reject();
                        }
                      })
                      .catch(({ errors }) => {
                    ...
                    schema
                      ...
                      .then((valid) => {
                        if (valid) {
                          ...
                          toast.warning('Out of Pocket Expenses data inputted is incomplete/invalid.', 2000);
                          reject();
                        }
                      })
                      .catch(({ errors }) => {
