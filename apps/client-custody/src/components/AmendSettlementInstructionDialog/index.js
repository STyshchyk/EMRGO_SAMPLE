...
import RaiseSettlementInstructionForm, { buildRaiseSIRequestPayload } from '../RaiseSettlementInstructionForm';
...
const AmendSettlementInstructionDialog = ({ open, handleClose, currentlySelectedRowData }) => {
  ...
  const handleSubmit = (values) => {
    const updateSettlementInstruction = (payload) => dispatch(paymentAndSettlementActionCreators.doUpdateSettlementInstruction(payload));
