...
import { DocHistory, dateRenderer, ActionMenu, CategoryRenderer, StatusRenderer } from '../../constants/documents/renderers';
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <TableContainer>
          <Table className={classes.table} aria-labelledby="" size="medium" aria-label="files table">
        ...
        <div>
          <TablePagination
            ...
            labelDisplayedRows={({ from, to, count }) => `${from} - ${to} ${t('documents:of')} ${count}`}
