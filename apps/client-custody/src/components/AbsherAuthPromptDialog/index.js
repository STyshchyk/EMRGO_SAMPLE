      ...
      <DialogContent>
        ...
        >
          <ErrorBanner
            ...
            description={t("auth:You will be transferred immediately to the National Single Sign-On page for authentication using your 'Absher' user name and password")}
