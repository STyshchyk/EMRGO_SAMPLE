...
const AddFXTransactionDialog = ({ open, handleClose, currentlySelectedDateRange }) => {
  ...
  const generateAccountOptionsList = (entity, currency) => {
    ...
    if (entity) {
      ...
      filteredOptions = filteredOptions.map((acc) => ({ label: acc?.accountNo, value: acc?.accountNo, id: acc?.id }));
  ...
  useEffect(() => {
    ...
    if (!fetchingValues && data?.value && data?.value !== 'null' && data?.key === 'NewFxTransactionForm') {
        ...
        {({ values, handleSubmit, setFieldValue, setValues, setFieldTouched, setTouched, touched, handleBlur }) => {
          ...
          return (
            <form onSubmit={handleSubmit} onKeyDown={onKeyDown}>
              ...
              <DialogTitle id="form-dialog-title"> {t('fx_transactions:Fx Modal.New Fx Transaction')}</DialogTitle>
              ...
              <DialogContent>
                <Box mb={2}>
                  <Grid container>
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6} alignContent="flex-start">
                        <Typography className="mt-4">{t('fx_transactions:Fx Table.From Amount')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} alignContent="center" className="px-1">
                        <Field
                          fullWidth
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6} alignContent="flex-start">
                        <Typography className="mt-4">{t('fx_transactions:Fx Table.From Currency')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} alignContent="center" className="px-1">
                        <FormControl className="w-full">
                          <Select
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6} alignContent="flex-start">
                        <Typography className="mt-4">{t('fx_transactions:Fx Table.Debit Account')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} alignContent="center" className="px-1">
                        <FormControl className="w-full">
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6} alignContent="flex-start">
                        <Typography className="mt-4">{t('fx_transactions:Fx Table.To Currency')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} alignContent="center" className="px-1">
                        <FormControl className="w-full">
                          <Select
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6} alignContent="flex-start">
                        <Typography className="mt-4">{t('fx_transactions:Fx Table.Credit Account')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} alignContent="center" className="px-1">
                        <FormControl className="w-full">
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6} alignContent="flex-start">
                        <Typography className="mt-4">{t('fx_transactions:Fx Table.Narrative')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} alignContent="center" className="px-1">
                        <Field
                          fullWidth
