...
const AddSecurityDialog = ({ open, handleClose, selectedRow, setSelectedRow }) => {
  ...
  const externalSecuritiesList = useSelector(externalSecuritiesSelectors.selectExternalSecuritiesList);

  const fetchExternalSecuritiesList = () => dispatch(externalSecuritiesActionCreators.doFetchExternalSecuritiesList());

  useEffect(() => {
    const fetchFormOptions = (payload) => dispatch(issuanceActionCreators.doFetchFormOptions(payload));
    fetchFormOptions({
  ...
  const selectedExternalSecurities = externalSecuritiesList?.find(({ id }) => selectedRow?.id === id);
  ...
  useEffect(() => {
    if (selectedRow || selectedExternalSecurities) {
      setInitialValues({
        ...
        denomination: selectedRow?.denomination ? selectedExternalSecurities.denominationName : null,
        status: selectedRow?.status ? selectedExternalSecurities.status : null,
      });
    } else {
      const data = formvalues?.settings[0];
      if (!fetchingValues && data?.value && data?.value !== 'null' && data?.key === 'AddSecurityDialogForm') {
        ...
        >
          {({ handleSubmit, setFieldValue, values, disableSelectCurrencyField }) => (
            <form onSubmit={handleSubmit} noValidate>
              <AutoSaveFields selectedRow={selectedRow} formKey="AddSecurityDialogForm" initial={initial} />
              <DialogTitle id="add-payment-account-form-dialog-title">
                <Grid container justifyContent="space-between">
                  <Grid item xs container alignContent="center">
                    <strong>{isEdit ? t('external_securities:External Securities.Edit Security') : t('external_securities:External Securities.New Security')}</strong>
                  </Grid>
                  ...
                  <Grid container>
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Security Name')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <Field
                          fullWidth
                          component={TextField}
                          label={t('external_securities:External Securities.Add Security Form.Security Name')}
                          name="name"
                          variant="filled"
                          type="text"
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Security Short Name')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <Field
                          fullWidth
                          component={TextField}
                          label={t('external_securities:External Securities.Add Security Form.Security Short Name')}
                          name="shortName"
                          variant="filled"
                          type="text"
                        />
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Security Long Name')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <Field fullWidth component={TextField} label={t('external_securities:External Securities.Add Security Form.Security Long Name')} name="longName" variant="filled" type="text" />
                      </Grid>
                    </Grid>

                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Issuance Name')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <Field fullWidth component={TextField} label={t('external_securities:External Securities.Add Security Form.Issuance Name')} name="issuanceName" variant="filled" type="text" />
                      </Grid>
                    </Grid>
                    {/* <Grid  container className="mt-4">
                      <Grid item xs={12} md={6} lg={6} >
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.ISIN')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <Field fullWidth component={TextField} label={t('external_securities:External Securities.Add Security Form.ISIN')} name="isin" variant="filled" type="text" />
                      </Grid>
                    </Grid>

                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Ticker')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <Field fullWidth component={TextField} label={t('external_securities:External Securities.Add Security Form.Ticker')} name="ticker" variant="filled" type="text" />
                      </Grid>
                    </Grid>

                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Rate')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        {/* <Field
                          fullWidth
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Frequency')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        ...
                        <ErrorMessage component={Typography} variant="caption" color="error" className="ml-4" name="frequency" />
                      </Grid>
                    </Grid>

                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Country')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <FormControl className="w-full">
                          <Select
                            ...
                            options={getDropdownValues(normalisedCountries(formOptions?.country), locale)}
                            onChange={(selected) => {
                              setFieldValue('country', selected);
                            }}
                          />
                        </FormControl>
                        <ErrorMessage component={Typography} variant="caption" color="error" className="ml-4" name="country" />
                      </Grid>
                    </Grid>

                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Issue Date')} </Typography>
                      </Grid>
                      <Grid xs={12} md={6} lg={6} className="px-1">
                        <Field fullWidth format="DD/MM/yyyy" inputVariant="filled" variant="dialog" placeholder="DD/MM/YYYY" component={KeyboardDatePicker} name="issueDate" />
                      </Grid>
                    </Grid>

                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Maturity Date')} </Typography>
                      </Grid>
                      <Grid xs={12} md={6} lg={6} className="px-1">
                        <Field fullWidth format="DD/MM/yyyy" inputVariant="filled" variant="dialog" placeholder="DD/MM/YYYY" minDate={moment()} component={KeyboardDatePicker} name="maturityDate" />
                      </Grid>
                    </Grid>

                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Currency')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <FormControl className="w-full">
                          <Select
                        ...
                        <ErrorMessage component={Typography} variant="caption" color="error" className="ml-4" name="currency" />
                      </Grid>
                    </Grid>

                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Issuance Amount')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <Field
                          fullWidth
                          component={TextField}
                          label={t('external_securities:External Securities.Add Security Form.Issuance Amount')}
                          name="issuanceAmount"
                          variant="filled"
                          type="text"
                        />
                    ...
                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Denomination')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <FormControl className="w-full">
                          <Select
                        ...
                        <ErrorMessage component={Typography} variant="caption" color="error" className="ml-4" name="denomination" />
                      </Grid>
                    </Grid>

                    <Grid container className="mt-4">
                      <Grid item xs={12} md={6} lg={6}>
                        <Typography className="mt-4">{t('external_securities:External Securities.Add Security Form.Status')}</Typography>
                      </Grid>
                      <Grid item xs={12} md={6} lg={6} className="px-1">
                        <FormControl className="w-full">
                          <Select
                        ...
                        <ErrorMessage component={Typography} variant="caption" color="error" className="ml-4" name="status" />
                      </Grid>
                    </Grid>
                  </Grid>
                </Box>
