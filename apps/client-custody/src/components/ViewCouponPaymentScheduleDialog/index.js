...
const ViewCouponPaymentScheduleDialog = ({ couponId, securityData, open, handleClose }) => {
  ...
  return (
    <Fragment>
      ...
      >
        <StyledDialogHeader title={t('Coupon Payment Schedule.Coupon Payment Schedule')} handleClose={handleClose} />
        <DialogContent>
          <div
            style={{
              marginBottom: '1rem',
          ...
          >
            ...
            <Grid container spacing={2}>
              <Grid item>
                <div>
                  <strong>{`${t('Coupon Payment Schedule.Status')}: ${couponPaymentScheduleStatus}`}</strong>
                </div>
                <div>
                  <strong>{`${t('Coupon Payment Schedule.Last Updated')}: ${couponPaymentScheduleUpdatedAt}`}</strong>
                </div>
              </Grid>
