...
const ViewSecuritiesRegistrationDialog = ({ sukukData, open, handleClose }) => {
  ...
  return (
    ...
    >
      <StyledDialogHeader title={t('securitiesRegistration:DialogTitle')} handleClose={handleClose} />
      <DialogContent>
        <Box mb={2}>
          <Grid container spacing={2} direction="column">
            ...
            <Grid item>
              <PrimaryIssuanceDetails termsheetInfo={termsheetInfo} admissionTermsheetData={admissionTermsheetData} disableDocumentsAccordionItem={!['ISSUER'].includes(currentEntityType)} />
            </Grid>
          </Grid>
        </Box>
      </DialogContent>
