...
const InvoiceManagementTable = ({ anchorEl, data, actions, setCurrentlySelectedRowData, setAnchorEl, currentlySelectedRowData }) => {
  ...
  return (
    <Fragment>
      <FilterProvider tableKey="client_rate_card">
        <div className="mb-4">
          <TableFiltersWrapper tableRef={tableRef} columns={columns} tableKey="client_rate_card" hideExportButtons>
            <Grid container spacing={2}>
              <Grid item xs={12} md={12} lg={6}>
                <DateRangePicker name="lastUpdatedDateRange" label="Updated Date" defaultFilter={defaultFilter} />
              </Grid>
