...
const AddCounterpartyDialog = ({ open, handleClose, selectedRow, setSelectedRow }) => {
  ...
  const fetchCounterpartyList = () => dispatch(counterpartyActionCreators.doFetchCounterpartyList());
  ...
  useEffect(() => {
    if (selectedRow || selectedCounterparty) {
      ...
      if (!fetchingValues && data?.value && data?.value !== 'null' && data?.key === 'CounterpartyForm') {
        ...
        values = { ...initialValues, entity: getInitialEntityValue(), status: counterpartyStatusOptionsList[1] };
        setInitialValues(values);
      }
    }
      ...
      >
        {({ values, handleSubmit, setFieldValue }) => (
          <form onSubmit={handleSubmit}>
            <AutoSaveFields selectedRow={selectedRow} formKey="CounterpartyForm" initial={initial} />
            <DialogTitle id="form-dialog-title"> {isEdit ? t('counterparty:Counterparty.Edit Counterparty') : t('counterparty:Counterparty.New Counterparty')}</DialogTitle>
                ...
                <Grid container>
                  <Grid item xs={12} lg={12} container className="mt-4">
                    <Grid item xs={12} md={6} lg={6} container alignContent="flex-start">
                      <Typography className="mt-4">{t('counterparty:Counterparty.Add Counterparty Form.Entity')}</Typography>
                    </Grid>
                  ...
                  <Grid item xs={12} lg={12} container className="mt-4">
                    <Grid item xs={12} md={6} lg={6} container alignContent="flex-start">
                      <Typography className="mt-4">{t('counterparty:Counterparty.Add Counterparty Form.Counterparty ID')}</Typography>
                    </Grid>
                    <Grid item xs={12} md={6} lg={6} container alignContent="center" className="px-1">
                      <Field
                        fullWidth
                  ...
                  <Grid item xs={12} lg={12} container className="mt-4">
                    <Grid item xs={12} md={6} lg={6} container alignContent="flex-start">
                      <Typography className="mt-4">{t('counterparty:Counterparty.Add Counterparty Form.Short Name')}</Typography>
                    </Grid>
                    <Grid item xs={12} md={6} lg={6} container alignContent="center" className="px-1">
                      <Field fullWidth component={TextField} label={t('counterparty:Counterparty.Add Counterparty Form.Short Name')} name="shortName" variant="filled" type="text" />
                    </Grid>
                  </Grid>

                  <Grid item xs={12} lg={12} container className="mt-4">
                    <Grid item xs={12} md={6} lg={6} container alignContent="flex-start">
                      <Typography className="mt-4">{t('counterparty:Counterparty.Add Counterparty Form.Long Name')}</Typography>
                    </Grid>
                    <Grid item xs={12} md={6} lg={6} container alignContent="center" className="px-1">
                      <Field fullWidth component={TextField} label={t('counterparty:Counterparty.Add Counterparty Form.Long Name')} name="longName" variant="filled" type="text" />
                    </Grid>
                  </Grid>

                  <Grid item xs={12} lg={12} container className="mt-4">
                    <Grid item xs={12} md={6} lg={6} container alignContent="flex-start">
                      <Typography className="mt-4">{t('counterparty:Counterparty.Add Counterparty Form.Status')}</Typography>
                    </Grid>
                    <Grid item xs={12} md={6} lg={6} container alignContent="center" className="px-1">
                      <FormControl className="w-full">
                        <Select
