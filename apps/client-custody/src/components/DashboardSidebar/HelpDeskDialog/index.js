...
const HelpDeskDialog = ({ open, handleClose }) => {
  ...
  const helpDeskEmailAddress = appConfig.appRegion === 'SA' ? HELP_DESK_EMAIL_ADDRESS_KSA : HELP_DESK_EMAIL_ADDRESS;

  return (
    <Dialog open={open} onClose={handleClose} aria-labelledby="alert-dialog-title" aria-describedby="alert-dialog-description">
      <DialogTitle id="alert-dialog-title">{t('Sidebar.Help Desk Modal.Connect with Emrgo?')}</DialogTitle>
      <DialogContent>
      ...
      <DialogActions>
        ...
        <Button target="_blank" rel="noopener noreferrer" href={`mailto:${helpDeskEmailAddress}`} variant="contained" color="primary" autoFocus>
