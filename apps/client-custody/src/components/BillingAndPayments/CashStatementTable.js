...
function CashStatementTableHead() {
  ...
  const headCells = [
    ...
    { id: 'transactionType', label: t('cash_management:Cash Statement.Headers.Transaction_Balance Type') },
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <TableContainer>
          <Table className={classes.table} aria-labelledby="Files" size="medium" aria-label="files table">
        ...
        <TablePagination
          ...
          labelDisplayedRows={({ from, to, count }) => `${from} - ${to} ${t('cash_management:of')} ${count}`}
