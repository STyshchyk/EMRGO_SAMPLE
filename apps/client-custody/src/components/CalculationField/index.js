...
const CalculationField = ({ fieldLabel, fieldKey, handleOnBlur, touched, values, handleFieldReset }) => {
    ...
    <Grid container className="mt-4">
      ...
      <Grid item xs={12} md={6} lg={6} alignContent="center" className="px-1">
        <Field
          ...
          InputProps={{
            endAdornment: isTouched && (
              <InputAdornment position="end">
                <Tooltip placement="left" title={t('fx_transactions:Fx Modal.Buttons.Reset User Input')}>
                  <IconButton
                    aria-label="reset"
                    size="small"
                    color="primary"
          ...
          helperText={isTouched ? t('fx_transactions:Fx Modal.Value has been edited, changes are locked') : undefined}
        />
      </Grid>
    </Grid>
  );
