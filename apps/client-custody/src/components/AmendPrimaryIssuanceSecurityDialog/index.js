              ...
              {({ setFieldValue, values, disableSelectCurrencyField }) => (
                <Form>
                  <Grid container spacing={2}>
                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Security Name')}>
                      <Field fullWidth component={TextField} name="name" variant="filled" type="text" InputProps={{ readOnly: isEdit, disableUnderline: isEdit }} disabled />
                    </InlineFormField>

                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Security Short Name')}>
                      <Field disabled fullWidth component={TextField} name="shortName" variant="filled" type="text" />
                    </InlineFormField>

                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Security Long Name')}>
                      <Field disabled fullWidth component={TextField} name="longName" variant="filled" type="text" />
                    </InlineFormField>

                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Issuance Name')}>
                      <Field disabled fullWidth component={TextField} name="issuanceName" variant="filled" type="text" />
                    </InlineFormField>

                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Ticker')}>
                      <Field disabled fullWidth component={TextField} name="ticker" variant="filled" type="text" />
                    </InlineFormField>

                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.ISIN')}>
                      <Field fullWidth component={TextField} name="isin" variant="filled" type="text" />
                    </InlineFormField>

                    <InlineFormField label="Exchange Code">
                      <Field fullWidth component={TextField} name="exchangeCode" variant="filled" type="text" />
                    </InlineFormField>

                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Rate')}>
                      <Field
                        fullWidth
                        component={TextField}
                        name="profitRate"
                    ...
                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Frequency')}>
                      <Select
                        closeMenuOnSelect
                        placeholder="Select.."
                        components={{
                    ...
                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Issue Date')}>
                    ...
                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Maturity Date')}>
                    ...
                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Currency')}>
                      <Select
                        closeMenuOnSelect
                        placeholder="Select.."
                        components={{
                    ...
                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Issuance Amount')}>
                      <Field
                        fullWidth
                        component={TextField}
                        name="issuanceAmount"
                    ...
                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Denomination')}>
                      <Select
                        closeMenuOnSelect
                        placeholder="Select.."
                        components={{
                    ...
                    <InlineFormField label={t('external_securities:External Securities.Add Security Form.Status')}>
                      <Select
                        closeMenuOnSelect
                        placeholder="Select.."
                        components={{
                    ...
                    <InlineFormField label="Guarantor">
                      <Field fullWidth component={TextField} label="Guarantor" name="guarantor" variant="filled" type="text" />
                    </InlineFormField>
                    ...
                    <InlineFormField label="Maturity Amount">
                      <Field fullWidth InputProps={{ type: 'number' }} component={TextField} name="maturityAmount" variant="filled" type="text" />
                    </InlineFormField>
