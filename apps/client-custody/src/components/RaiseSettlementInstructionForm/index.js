  ...
  return (
    <>
      <Field
        ...
        disabled={!values.externalSecuritySelectOption?.value?.currencyName || ['DFOP', 'RFOP'].includes(values.settlementTypeSelectOption?.label)}
        InputProps={{
...
export const buildRaiseSIRequestPayload = (formikValues) => {
  ...
  const requestPayload = {
    ...
    principalAmount: !formikValues.principalAmount ? 0 : parseFloat(formikValues.principalAmount, 10),
    accruedInterest: !formikValues.accruedInterest ? 0 : parseFloat(formikValues.accruedInterest, 10),
...
const RaiseSettlementInstructionForm = ({
  ...
  const settlementInstructionTypeOptionsList = generateSettlementInstructionTypeOptionsList(dropdownOptions?.settlementInstructionType);
  ...
  */
  return (
    <MuiPickersUtilsProvider utils={MomentUtils}>
      <Formik initialValues={initialValues} onSubmit={handleSubmit} enableReinitialize validationSchema={addSettlementInstructionFormSchema}>
            ...
            <Grid container spacing={2}>
                ...
                <Fragment>
                  ...
                  <InlineFormField label={'Entity Group User'}>
                    <Select
                      ...
                      options={generateEntityGroupUserOptionsList(selectedEntityGroupOption?.value?.users)}
                      onChange={(newValue) => {
              ...
              <InlineFormField label={'Principal Amount'}>
                <DependentAmountField
                  ...
                  calculatedValue={(values.price / 100) * values?.quantity}
                />
              </InlineFormField>
              ...
              <InlineFormField label={'Settlement Amount'}>
                <DependentAmountField
                  ...
                  calculatedValue={+values?.principalAmount + +values?.accruedInterest}
                />
              </InlineFormField>
              ...
              <InlineFormField label="Counterparty SSI">
                <Select
                  ...
                  options={generateCounterpartySSIOptionsList(values.counterpartySelectOption?.value?.counterpartySSI)}
                  onChange={(newValue) => {
              ...
              <Grid item container spacing={2} justifyContent="flex-end">
                ...
                <Grid item>
                  <Button color="primary" variant="contained" type="submit" disabled={isSubmitting || (isWethaqUser && !selectedEntityOption && !editable)}>
                    Submit
                  </Button>
                </Grid>
              </Grid>
