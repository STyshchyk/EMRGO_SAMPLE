...
const ViewTradeDetailsDialog = ({ open, handleClose, currentlySelectedRowData }) => {
  ...
  const transformCounterpartySSIData = (counterpartySSIData) => {
    ...
    const { ssiLabel, counterparty, deliveryAgentIdentifier, sellerIdentifier, sellerIdentifierType, entity, settlementLocation, safekeepingAccount, deliveryAgentIdentifierType } =
      counterpartySSIData;
  ...
  const transformTradeDetails = (tradeData) => {
    ...
    return [
      ...
      },
      {
        ...
        value: (issuerSecuritiesAccountNo && convertNumberToIntlFormat(issuerSecuritiesAccountNo)) || FALLBACK_VALUE,
      },
      {
        label: t('Headers.Iss Sec Acc Bal'),
        value: (issuerSecuritiesAccountBalance && convertNumberToIntlFormat(issuerSecuritiesAccountBalance)) || FALLBACK_VALUE,
      },
      {
        label: t('Headers.Qty'),
        value: quantity,
  ...
  const transformedSSIData = transformCounterpartySSIData(currentlySelectedRowData?.counterpartySSIObject);
