...
import { currencyRenderer, floatRenderer, fontColorRenderer, quoteDateRenderer, tooltipRenderer } from '../../constants/paymentAndStatuses/renderers';
...
const QuotesTable = ({ data, actions, setSelectedRow, selectedRow }) => {
  ...
  const headCells = [
    ...
    },
    {
      ...
      field: 'bidYield',
      render: (rowData) => (rowData.bidYield !== '0.00' ? fontColorRenderer(rowData.bidYield, 'red') : ''),
      width: 100,
    },
    {
      title: t('bulletin_board:Headers.Bid Px'),
      field: 'bidPrice',
      render: (rowData) => (rowData.bidPrice !== '0.00' ? fontColorRenderer(floatRenderer(rowData.bidPrice), 'red') : ''),
      width: 100,
    },
    {
      title: t('bulletin_board:Headers.Ask Px'),
      field: 'askPrice',
      render: (rowData) => (rowData.askPrice !== '0.00' ? fontColorRenderer(floatRenderer(rowData.askPrice), 'green') : ''),
      width: 120,
    },
    {
      title: t('bulletin_board:Headers.Ask Yld'),
      field: 'askYield',
      render: (rowData) => (rowData.askYield !== '0.00' ? fontColorRenderer(floatRenderer(rowData.askYield), 'green') : ''),
      width: 120,
    },
    {
