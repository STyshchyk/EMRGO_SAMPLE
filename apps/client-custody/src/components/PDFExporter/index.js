...
Font.register({
  ...
  fonts: [
    ...
    { src: 'https://d1l2ge0agmsvzm.cloudfront.net/assets/fonts/D-DINExp-Italic.woff', fontStyle: 'italic' },
    { src: 'https://d1l2ge0agmsvzm.cloudfront.net/assets/fonts/D-DINExp-Bold.woff', fontWeight: 700 },
  ],
});
