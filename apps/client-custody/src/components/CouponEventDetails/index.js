...
const CouponEventDetails = ({ couponEventData }) => {
  ...
  const formattedCouponRate = `${convertNumberToIntlFormat(couponEventData?.couponRate, { ...numberIntlFormatOps })}%`;
  ...
  const issuerAccountBalance = convertNumberToIntlFormat(couponEventData?.issuer?.wethaqAccount?.accountBalance, numberIntlFormatOps);
      ...
      {isPrimaryIssuance ? (
        ...
        <Grid item container justifyContent="space-between" spacing={1}>
          ...
          <Grid item container md={12} justifyContent="space-between">
            ...
            <Grid item>
              <Typography>{csdSourceAccountBalance && convertNumberToIntlFormat(csdSourceAccountBalance, { maximumFractionDigits: 2, minimumFractionDigits: 2 })}</Typography>
            </Grid>
          </Grid>
        </Grid>
      )}
