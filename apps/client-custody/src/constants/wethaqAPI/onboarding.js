...
export default [
  ...
  },
  {
    ...
    roles: [
      ...
      { label: i18n.language === 'ar-SA' ? 'مقدم خدمات ائتمانية' : 'Fiduciary Service Provider', value: 'FIDUCIARY' },
    ],
  },
  { label: i18n.language === 'ar-SA' ? 'Other' : 'Other', value: 'OTHER', roles: [{ label: i18n.language === 'ar-SA' ? 'المُصدر' : 'Issuer', value: 'ISSUER' }] },
];
