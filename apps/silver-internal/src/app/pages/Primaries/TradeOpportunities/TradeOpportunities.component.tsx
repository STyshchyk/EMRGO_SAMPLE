  ...
  return (
    <DashboardContent>
      ...
      <Styles.Button>
        ...
        <Button
          onClick={() => {
            navigate(routes.dash.primaries.tradeOpportunity.manageIssuers);
          }}
        >
          Manage Issuers
        </Button>
        <Button
          onClick={() => {
            navigate(routes.dash.primaries.tradeOpportunity.manageSellside);
          }}
        >
          Manage Sellside
        </Button>
      ...
      {/*  <Dropdown items={filterTypes} value={filterType} onChange={setFilterType} />*/}
      {/*  <Dropdown items={filterStatuses} value={filterStatus} onChange={setFilterStatus} />*/}
