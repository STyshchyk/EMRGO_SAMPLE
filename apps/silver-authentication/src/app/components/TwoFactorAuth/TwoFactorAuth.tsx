    ...
    <Styles.TwoFactorAuth position={position}>
      <Formik
        ...
        validationSchema={Yup.object().shape({
          otp: Yup.string().required("Required").min(6, "Enter 6 digits"),
        })}
      >
            ...
            <Styles.MainWrapper isVisible={mode === 1}>
              <Styles.LeftColumn isVisible={mode === 1}>
                ...
                <SubHeading align={"center"}>
                  ...
                  Google Authenticator, Microsoft Authenticator, Authy or any other 2FA supported
                  app that you currently use
                </SubHeading>
              </Styles.LeftColumn>
              <Styles.RightColumn>
                <Heading align={"center"}>Enter Security Code</Heading>
                <SubHeading align={"center"}>
                  Enter the security code generated by your two-factor authentication app. You will
                  be provided a new security code every 30 seconds.
                </SubHeading>
                <OneCol>
                  <SixDigitCodeInput
                    value={values.otp}
